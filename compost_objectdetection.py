...
IMAGES_DIR = '/Users/yasnara/Desktop/images_new_new' # Change if applicable
csv_path = '/Users/yasnara/Desktop/simple_image_annotator-master/out.csv' # assumes CSV column format is image,id,name,xMin,xMax,yMin,yMax
